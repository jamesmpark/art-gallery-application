    ...
    <>
      ...
      <div className="about-container">
        <div className="about-content">
          ...
          <p>
            This project was created for the purpose of showcasing my passion
            for creating things but also as a learning tool to help me
            understand various React principles.
          </p>
          <br />
          <p>
